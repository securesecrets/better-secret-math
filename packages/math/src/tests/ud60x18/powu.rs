use super::*;
use crate::ud60x18::{powu, E, MAX_UD60X18, MAX_WHOLE_UD60X18, PI, SQRT_MAX_UD60X18};
...
#[case(
    U256::new(38685626227668133590597631999999999999),
    U256::new(3),
    U256::from_words(0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFF2, 0xCE4CDF1D90732CDEF20133F625121A7D)
)]
#[case(
    SQRT_MAX_UD60X18,
    U256::new(2),
    U256::from_words(0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF, 0xFFFFFFF768FA0BEC94B5A68CE97F5770)
)]
