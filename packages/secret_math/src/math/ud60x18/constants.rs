...
pub const MAX_SCALED_UD60X18: U256 = U256::from_words(0x12725DD1D243ABA0E7, 0x5FE645CC4873F9E65AFE688C928E1F21,
);

/// 340282366920938463463374607431_768211455999999999
pub const SQRT_MAX_UD60X18: U256 = U256::from_words(
    0x3B9AC9FF, 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
);
