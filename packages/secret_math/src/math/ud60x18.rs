    ...
    pub fn log10(x: U256) -> StdResult<U256> {
        ...
        // prettier-ignore
            match x {
                ...
                // =>  result = mul(SCALE, U256::new(21u128)),
                // =>  result = mul(SCALE, U256::new(22u128)),
                // =>  result = mul(SCALE, U256::new(23u128)),
                // =>  result = mul(SCALE, U256::new(24u128)),
                // =>  result = mul(SCALE, U256::new(25u128)),
                // =>  result = mul(SCALE, U256::new(26u128)),
                // =>  result = mul(SCALE, U256::new(27u128)),
                // =>  result = mul(SCALE, U256::new(28u128)),
                // =>  result = mul(SCALE, U256::new(29u128)),
                // =>  result = mul(SCALE, U256::new(30u128)),
                // =>  result = mul(SCALE, U256::new(31u128)),
                // =>  result = mul(SCALE, U256::new(32u128)),
                // =>  result = mul(SCALE, U256::new(33u128)),
                // =>  result = mul(SCALE, U256::new(34u128)),
                // =>  result = mul(SCALE, U256::new(35u128)),
                // =>  result = mul(SCALE, U256::new(36u128)),
                // =>  result = mul(SCALE, U256::new(37u128)),
                // =>  result = mul(SCALE, U256::new(38u128)),
                // =>  result = mul(SCALE, U256::new(39u128)),
                // =>  result = mul(SCALE, U256::new(40u128)),
                // =>  result = mul(SCALE, U256::new(41u128)),
                // =>  result = mul(SCALE, U256::new(42u128)),
                // =>  result = mul(SCALE, U256::new(43u128)),
                // =>  result = mul(SCALE, U256::new(44u128)),
                // =>  result = mul(SCALE, U256::new(45u128)),
                // =>  result = mul(SCALE, U256::new(46u128)),
                // =>  result = mul(SCALE, U256::new(47u128)),
                // =>  result = mul(SCALE, U256::new(48u128)),
                // =>  result = mul(SCALE, U256::new(49u128)),
                // =>  result = mul(SCALE, U256::new(50u128)),
                // =>  result = mul(SCALE, U256::new(51u128)),
                // =>  result = mul(SCALE, U256::new(52u128)),
                // =>  result = mul(SCALE, U256::new(53u128)),
                // =>  result = mul(SCALE, U256::new(54u128)),
                // =>  result = mul(SCALE, U256::new(55u128)),
                // =>  result = mul(SCALE, U256::new(56u128)),
                // =>  result = mul(SCALE, U256::new(57u128)),
                // =>  result = mul(SCALE, U256::new(58u128)),
                // =>  result = mul(SCALE, U256::new(59u128)),
